...
function displayRepositories() {
  ...
  const repos = `<ul>${ reposResponse
    .map(
      repo =>
       '<li>' + repo.name + ' - <a href="' + repo.html_url + '">' + repo.html_url + '</a> + ' + '- <a href="#" data-owner="' + repo.owner.login + '- <a href="#" data-name="' + repo.name + ''" onclick="getCommits(this)">Get Commits</a>' + ' <a href="#" data-fullname= "' + repo.full_name + '"onclick="getBranches(this)">Get Branches</a></li>'
    ).join(' ')}</ul>`;
